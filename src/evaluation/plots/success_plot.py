...
models = ['CNN', 'Faster RCNN', 'Yolo']
colors = ['r', 'b', 'g']

txt_paths = ["/root/src/own_model/best_model/evaluation/region_overlap.txt",
             "/root/src/own_model/faster_rcnn_model/evaluation/region_overlap.txt",
             "/root/src/own_model/yolo_model/evaluation/region_overlap.txt"]
